        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Travels_Organizations_OrganizationId",
            ...
            migrationBuilder.InsertData(
                table: "Organizations",
                columns: new[] { "Id", "Nip", "Regon", "Title", "Address_City", "Address_PostalCode", "Address_Region", "Address_Street" },
                values: new object[] { 2, "2498534", "0873439249", "Administracja", "Kraków", "31-150", "małopolskie", "Krowoderska 45/6" });
            ...
            migrationBuilder.InsertData(
                table: "Travels",
                columns: new[] { "Id", "EndDate", "EndPlace", "Guide", "Name", "OrganizationId", "Participants", "StartDate", "StartPlace" },
                values: new object[] { 1, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Luna", "Luis", "Viaje a la luna", 1, "Juan, Pedro, Luis", new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Madrid" });

            migrationBuilder.InsertData(
                table: "Travels",
                columns: new[] { "Id", "EndDate", "EndPlace", "Guide", "Name", "OrganizationId", "Participants", "StartDate", "StartPlace" },
                values: new object[] { 2, new DateTime(2021, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Luna", "Luis", "Viaje a la luna 2", 2, "Juan, Pedro, Luis", new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Madrid" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Travels_OrganizationId",
                table: "Travels",
